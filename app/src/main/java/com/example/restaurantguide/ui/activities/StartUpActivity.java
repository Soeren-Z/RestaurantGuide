...
public class StartUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // "Log a Restaurant" button, takes you to MainActivity
        Button logRestaurantButton = findViewById(R.id.logRestaurantButton);
        ...
        // About the Team text
        TextView aboutTeamText = findViewById(R.id.aboutTeamText);
